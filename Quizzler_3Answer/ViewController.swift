...
// MARK: - Private Methodes
    ...
    private func setupView() {
        ...
        firstButton.addTarget(self, action: #selector(answerButtonTapped(_:)), for: .touchUpInside)
        
        secondButton.setTitle("SecondButton", for: .normal)
        secondButton.addTarget(self, action: #selector(answerButtonTapped(_:)), for: .touchUpInside)
        
        thirdButton.setTitle("ThirdButton", for: .normal)
        thirdButton.addTarget(self, action: #selector(answerButtonTapped(_:)), for: .touchUpInside)
    }
